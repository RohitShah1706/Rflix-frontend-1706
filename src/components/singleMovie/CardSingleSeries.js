...
const CardSingleSeries = () => {
    ...
    useEffect(() => {
        var url = `https://api.themoviedb.org/3/find/${imdbId}?api_key=${process.env.REACT_APP_TMDB_API_KEY}&language=en-US&external_source=imdb_id`
